...
REPO_DIR = os.path.join(BASE_DIR, 'db')
GENERATED_DIR = os.path.join(BASE_DIR, 'generated')

CONFIG_DIR = os.path.join(GENERATED_DIR, 'config')
FLYWAY_FILESYSTEM_DIR = os.path.join(GENERATED_DIR, 'sql')
FLYWAY_OUTPUT_DIR = os.path.join(GENERATED_DIR, 'output')
...
def generate_flyway_commands(scripts_to_deploy, command, environment='development'):
    ...
    _write_to_file(os.path.join(GENERATED_DIR, '{}.sh'.format(command)), migrate_cmds)
