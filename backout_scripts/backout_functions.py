...
def undo_create_table(table_name):
    """undo_create_table
...
def undo_drop_table(table_name, column_mapping):
    """undo_drop_table
...
def undo_add_column(table_name, column_name):
...
def undo_add_columns(table_name, column_names):
    """undo_add_columns
...
def undo_drop_column(table_name, column_mapping):
...
def undo_drop_columns(table_name, column_mapping):
    """undo_drop_columns
