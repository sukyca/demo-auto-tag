--  EDP_CONSUMER.DW_NCRUA."T_TRANSACTION_TIMEDEPOSIT" definition

CREATE TABLE "T_TRANSACTION_TIMEDEPOSIT" (
	...
	constraint PK_TRANSACTION_TD_ID primary key (TRANSACTION_ID)
);
